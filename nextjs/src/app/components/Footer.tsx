...
const Footer = ({t}) => {
  ...
  return (
    <footer className='flex flex-col justify-end py-8 bg-footer bg-blend-darken bg-black/95 text-white px-4 min-h-[100vh] shadow-inset-black'>
        ...
        <div className='pt-2 w-full flex flex-col justify-center items-center'>
          ...
          <div className="w-full flex flex-col md:flex-row justify-center items-center gap-4 md:gap-12 mt-8 text-sm">
            ...
            <p>© 2024 PLKGalacticos. {t['footer.copy']} </p>
          </div>
        </div>
    </footer>
  )
