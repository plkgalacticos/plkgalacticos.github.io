...
const Join = ({t}) => {
  ...
  return (
    <section className='relative bg-join bg-center bg-no-repeat bg-cover bg-center-safari bg-blend-darken bg-black/70 flex flex-col justify-center items-center gap-12 text-center min-h-[100vh]'>
